...
#
# SPEC GAP NOTE: Flux provides db.ins but does NOT expose INSERT ... ON CONFLICT
...
# because the key already exists, the caller must catch that — but Flux has NO
...
# would be upsert / ON CONFLICT DO NOTHING with a returned flag, which Flux does
